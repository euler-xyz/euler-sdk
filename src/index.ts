...
import addressesBaseGorli from "@eulerxyz/euler-interfaces/addresses/addresses-basetestnet.json";
...
const WETH_BASETESTNET = "0xe392ee380a9917d08b521e9488a66c83364678d2";
...
class Euler {
  ...
  constructor(
    ...
    if (networkConfig) {
      ...
      this.referenceAsset = WETH_BASETESTNET;
    } else {
